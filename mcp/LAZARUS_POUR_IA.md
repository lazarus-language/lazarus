...
> spécification complète et exacte du langage de programmation LAZARUS (v8.0),
...
## 5. Les 48 fonctions intégrées (signatures exactes)
...
---
*LAZARUS v8.0 — langage open source (MIT) créé par Ladji Doucaré.
